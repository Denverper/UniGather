                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        style: FlutterFlowTheme.of(context).bodyMedium,
                        validator: _model.contextControllerValidator
                            .asValidator(context),
                      ),
                    ),
                    FFButtonWidget(
                      onPressed: () async {
                        await PostsRecord.collection
                            ...
                            .set(createPostsRecordData(
                              ...
                              postDescription: _model.contextController.text,
                              postUser: currentUserReference,
                              timePosted: getCurrentTimestamp,
                              clubName: clubPostCopyClubsRecord.reference,
                            ));
                        Navigator.pop(context);
                      },
                      text: 'Submit',
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.network(
                            valueOrDefault<String>(
                              clubPostCopyClubsRecord.pictureUrl,
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: _model.updatedClubNameController ??=
                          ...
                          text: clubPostCopyClubsRecord.name,
                        ),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        controller: _model.updatedClubDescController ??=
                            TextEditingController(
                          text: clubPostCopyClubsRecord.description,
                        ),
              ...
              actions: [
                Visibility(
                  visible: (currentUserReference ==
                      ...
                      (currentUserReference == clubPostCopyClubsRecord.creator),
                  child: Padding(
                    padding:
                                ...
                                child: ToggleIcon(
                                  onPressed: () async {
                                    ...
                                    final postLikedByUpdate =
                                        clubPostCopyClubsRecord.postLikedBy
                                  ...
                                  value: clubPostCopyClubsRecord.postLikedBy
                          ...
                          child: StreamBuilder<List<PostsRecord>>(
                            stream: queryPostsRecord(
                              queryBuilder: (postsRecord) => postsRecord.where(
                                'club_name',
                                isEqualTo: clubPostCopyClubsRecord.reference,
                              ),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
